...
function draw() {
 ...
 if(constraintStone.body.isTouching(mango1.body)){
  Matter.Body.setStatic(mango1.body,false);
 }else if(constraintStone.body.isTouching(mango2.body)){
  Matter.Body.setStatic(mango2.body,false);
 }else if(constraintStone.body.isTouching(mango3.body)){
  Matter.Body.setStatic(mango3.body,false);
 }else if(constraintStone.body.isTouching(mango4.body)){
  Matter.Body.setStatic(mango4.body,false);
 }else if(constraintStone.body.isTouching(mango5.body)){
